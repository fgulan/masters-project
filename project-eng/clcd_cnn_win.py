...
y_min_value = np.min(y_train)
if y_min_value != 0:
    y_train -= y_min_value
    y_validation -= y_min_value
    y_test -= y_min_value
...
model.load_weights("weights/weights-05-0.919351.hdf5")
...
if use_augment:
    ...
    # checkpoint
    filepath="./weights/weights-{epoch:02d}-{val_acc:.6f}.hdf5"
